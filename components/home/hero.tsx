...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-white h-[calc(100vh-80px)] min-h-[600px] flex items-center">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 h-full py-12 lg:py-24">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-20 h-full">
          {/* Left Column: Text */}
          <div className="flex-1 space-y-6 lg:space-y-8 text-center lg:text-left flex flex-col justify-center">
            ...
            <p className="text-base md:text-xl text-foreground/80 max-w-2xl mx-auto lg:mx-0 font-sans leading-relaxed">
              Non-invasive, drug-free pain relief covered by Medicare, provided in the comfort of your home.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
              <Button asChild size="lg" className="bg-primary hover:bg-secondary text-primary-foreground text-lg h-12 px-8 shadow-md hover:shadow-lg transition-all">
                <Link href="/nfpm">Learn About NFPM</Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="border-primary text-primary hover:bg-muted text-lg h-12 px-8">
          ...
          <div className="flex-1 h-full w-full flex items-center justify-center lg:justify-end">
            <div className="relative h-full w-full max-h-full">
              <Image
                src="/assets/images/genis-homepage-hero.png"
